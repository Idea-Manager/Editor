 ...
 */
export class AttachToFrameCommand implements Command {
    ...
    this.operationRecords = [
      {
        ...
        wallClock: now,
        type: 'node:update',
        payload: { nodeId: elementId, path: 'frameId', oldValue: undefined, newValue: frameId },
      },
      {
        id: generateId('op'),
        actorId: 'local',
        ...
        wallClock: now,
        type: 'node:update',
        payload: { nodeId: frameId, path: 'childElementIds', oldValue: undefined, newValue: elementId },
      },
    ];
  }
