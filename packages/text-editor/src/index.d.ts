...
export type { SlashPaletteOptions, SlashPaletteLike, SlashPaletteFactory, FloatingToolbarConfig, FloatingToolbarSections, FloatingToolbarExtraButton, FloatingToolbarDeps, FloatingToolbarLike, FloatingToolbarFactory, BlockGutterConfig, ResolvedBlockGutterConfig, BlockGutterFactory, TableContextMenuConfig, ResolvedTableContextMenuConfig, TableContextMenuFactory, LinkHoverOptions, TextEditorToolbarsOptions, } from './toolbar/toolbar-options';
export { defaultFloatingToolbarConfig, mergeFloatingToolbarConfig, DEFAULT_FLOATING_TOOLBAR_SECTIONS, DEFAULT_CONVERTIBLE_BLOCK_TYPES, resolveBlockGutterConfig, resolveTableContextMenuConfig, } from './toolbar/toolbar-options';
