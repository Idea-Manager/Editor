...
export type SlashPaletteFactory = (ctx: EditorContext, host: HTMLElement, options?: SlashPaletteOptions) => SlashPaletteLike;
...
export declare const DEFAULT_FLOATING_TOOLBAR_SECTIONS: FloatingToolbarSections;
export declare const DEFAULT_CONVERTIBLE_BLOCK_TYPES: BlockType[];
export declare function defaultFloatingToolbarConfig(): FloatingToolbarConfig;
export declare function mergeFloatingToolbarConfig(partial?: Partial<FloatingToolbarConfig>): FloatingToolbarConfig;
...
export type FloatingToolbarFactory = (deps: FloatingToolbarDeps, config: FloatingToolbarConfig) => FloatingToolbarLike;
...
export declare function resolveBlockGutterConfig(c?: BlockGutterConfig): ResolvedBlockGutterConfig;
export type BlockGutterFactory = (ctx: EditorContext, host: HTMLElement, config: ResolvedBlockGutterConfig) => {
    destroy(): void;
};
...
export declare function resolveTableContextMenuConfig(c?: TableContextMenuConfig): ResolvedTableContextMenuConfig;
export type TableContextMenuFactory = (ctx: EditorContext, host: HTMLElement, config: ResolvedTableContextMenuConfig) => {
    destroy(): void;
};
export interface LinkHoverOptions {
    /** When true, no link hover UI is created. */
    disabled?: boolean;
    factory?: (ctx: EditorContext) => {
        destroy(): void;
    };
}
...
//# sourceMappingURL=toolbar-options.d.ts.map